...
//all options for different select tags 
...
const Customer = () => {
    ...
    //fetching all requests of customer
    const getData=async()=>{
    ...
    // rendering different issue options based on product type 
    const getOptions=()=>{
        switch(productType){
            case "Mobile Phone":
    ...
    //sumitting request to the portal
