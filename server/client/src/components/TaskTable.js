...
//Table to show allocated as well as unallocated tasks
const TaskTable = (props) => {
    const {data,allocated}=props;
    const [task,setTask]=useState([]);
    
    //fetching single request details based on id
    ...
    //requesting to assign task to the employee 
    const assignTaskhandler=async(id)=>{
        const response=await fetch(`/assign/${id}`,{
            method:"put",
            headers: {
